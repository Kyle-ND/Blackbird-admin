...
//     const formData = new FormData(e.target);
//     const email = formData.get("username") || "manager@blackbirdspa.com";
...
//       onLogin(role, formattedName);
//     } catch (err) {
//       // Even if login fails (401, network error, etc.), we still proceed as manager
//       console.warn("Login failed, but proceeding with mock manager login for demo:", err.message);

//       setError("Backend not available — entering demo mode as Manager");

//       // Force manager role and use email as name
...
//       // Call onLogin to go to Manager Dashboard
//       setTimeout(() => {
//         onLogin("manager", formattedName || "Manager");
...
//           {/* Logo + Welcome */}
//           <div className="text-center flex flex-col items-center">
//             <img src="/assets/logo.png" alt="Logo" className="w-40 mx-auto mb-4" />
//             <p className="text-[#8A7D6F] text-lg">Welcome back</p>
//           </div>
...
//             <form onSubmit={handleSubmit} className="space-y-6">
//               <div>
//                 <label className="block text-[#985f99] font-medium mb-3 text-lg">Email</label>
//                 <input
//                   name="username"
//                   type="email"
//                   required
//                   disabled={loading}
//                   placeholder="Enter your email (any for demo)"
//                   className="w-full px-6 py-5 rounded-2xl border border-[#D4AF87]/30 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-4 focus:ring-[#985f99]/30 transition-all text-[#985f99] placeholder-[#8A7D6F]/70 text-lg"
//                 />
//               </div>

//               <div>
//                 <label className="block text-[#985f99] font-medium mb-3 text-lg">Password</label>
//                 <input
//                   name="password"
//                   type="password"
//                   required
...
//               {error && (
//                 <div className="bg-yellow-50/90 backdrop-blur text-[#985f99] p-5 rounded-2xl text-center font-medium border border-[#D4AF87]/50">
//                   {error}
//                 </div>
//               )}
...
//                 type="submit"
//                 disabled={loading}
//                 className="w-full py-5 bg-[#985f99] text-white text-xl font-medium rounded-2xl hover:bg-[#7d4f80] transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed"
//               >
//                 {loading ? "Entering Sanctuary..." : "Enter Sanctuary"}
//               </button>
//             </form>
//           </div>
